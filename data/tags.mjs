[
  {
    ...
    meaning: {
      ...
      info: [
        ...
        "Las capacidad académica, está relacionada a la creencia y esperanza que tienen el cuidador sobre los resultados y logros académicos que puede llegar a tener el estudiante a lo largo de su ciclo académico. En general estas expectativas reflejan la confianza y las aspiraciones que los cuidadores depositan en el impacto del acompañamiento escolar.",
        "El cuidador considera que el acompañamiento escolar tiene el potencial de favorecer el avance y el rendimiento académico del estudiante. Además, se espera que este respaldo contribuya a que el estudiante supere obstáculos y desafíos, lo que permitiría que salgan adelante en su educación.",
        ...
        "El nivel académico se refiere al grado de formación y conocimiento que poseen tanto los cuidadores como los estudiantes en relación con los temas académicos. Este concepto aborda cómo el nivel de conocimiento y habilidades académicas puede influir en el grado del acompañamiento escolar. Desde la perspectiva del cuidador, se destaca cómo su nivel de formación académica y conocimiento puede afectar su acompañamiento.",
        ...
        "Por otro lado, el nivel académico pueden influir en el manejo de nuevas tecnologías y en el acompañamiento escolar, siendo este un desafío para programas de intervención académica, en lo que respecta a la partipación de los cuidadores.",
      ],
    },
  },
  {
    ...
    meaning: {
      paragraphs: 7,
      info: [
        "El compromiso académico abarca una serie de comportamientos, percepciones y actitudes frente al acompañamiento escolar que convergen hacia el enriquecimiento del proceso de aprendizaje y el desarrollo de los estudiantes.",
        ...
        "No obstante, también es posible la existencia de obstáculos y desafíos en el fomento del compromiso académico. Factores como la falta de tiempo, la resistencia al cambio y la falta de disposición pueden dificultar el acompañamiento escolar.",
  ...
  },
  {
    ...
    meaning: {
      ...
      info: [
        ...
        "Un rol activo, constante, consciente y participativo del cuidador facilita el aprendizaje y demuestra una disposición emocional para resolver las dudas académicas del estudiante, prestarle atención a sus necesidades, leerle y explicarle los temas de estudio, y permitirle resolver las responsabilidades académicas por sí mismo. Esto significa que el cuidador es consciente de las responsabilidades, expectativas, riesgos y resultados derivados del acompañamiento escolar.",
        "Es importante entender que el aprendizaje puede ser bidireccional, esto se refiere a que tanto el estudiante como el cuidador aprenden durante el proceso del acompañamiento escolar. Lo que implica reconocer al estudiante como una fuente valida de conocimiento, incluso por encima del cuidador o el docente, lo que puede favorecer el aumento de solicitudes de acompañamiento escolar por parte del estudiante.",
  ...
  },
  {
    ...
    meaning: {
      paragraphs: 11,
      info: [
        "Los recursos educativos, hacen referencia a los recursos academicos y pedagogicos dentro del proceso de educación. El primero está relacionado con las herramientas y materiales pedagógicos disponibles para el acompañamiento escolar, mientras que el segundo está relacionado a las herramientas, estrategias y enfoques pedagógicos utilizados para apoyar y mejorar el proceso educativo.",
        "Los recursos académicos, hacen referencia a las herramientas y materiales pedagógicos disponibles para el acompañamiento escolar. Estas herramientas y materiales pueden ser físicas o digitales.",
        "Desde la perspectiva del cuidador, recursos como el acceso a fuentes confiables de información como las guías, los materiales de estudio, o los libros permiten un acompañamiento escolar más activo, sin importar si estos son físicos o digitales.",
        ...
        "Estos recursos abarcan una variedad de métodos y materiales que se implementan con el objetivo de facilitar el aprendizaje. Desde la perspectiva del cuidador, diferentes tipos de actividades y enfoques pedagógicos pueden enriquecer el acompañamiento escolar.",
        "Las actividades lúdicas, como los juegos y las dinámicas interactivas, al igual que la comunicación constante con el docente, son consideradas como recursos valiosos para fortalecer el acompañamiento escolar y facilitar la comprensión y el aprendizaje de los estudiantes.",
